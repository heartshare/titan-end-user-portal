	...
	<tr>
		<td valign="top" align="left" width="350">
			<div class="menu-container">
				...
				<div class="menu">
					<ul>
						<li><a id="createVM" href=#><img
								src="../theme/<fmt:bundle basename="main"><fmt:message key="theme" /></fmt:bundle>/en/image/famfamfam/icons/add.png">
								<p>Create</p></a></li>
						<li><a id="deleteVM" href=#><img
								src="../theme/<fmt:bundle basename="main"><fmt:message key="theme" /></fmt:bundle>/en/image/famfamfam/icons/cross.png">
								<p>Delete</p></a></li>
					</ul>
				</div>
				...
				<table width="100%" id="serverTable" cellpadding="0" cellspacing="0">
					...
					<c:forEach items="${result}" var="item">
						<tr>
							...
							<td align="left"><a
								href="vmDetail.htm?instanceId=<c:out value="${item.id}"/>"><c:out
										value="${item.instanceName}" /></a></td>
							...
							<td align="left"><c:if test="${item.status == 'ERROR'}">
									<img
										src="../theme/<fmt:bundle basename="main"><fmt:message key="theme" /></fmt:bundle>/en/image/famfamfam/icons/error.png">
								</c:if> <c:out value="${item.status}" /></td>
							<td></td>
						</tr>
					</c:forEach>
				</table>
